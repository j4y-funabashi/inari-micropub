...
func renderHomepage(outBuf *bytes.Buffer, postList []mf2.MicroFormat, afterKey string) error {

	pl := []mf2.MicroFormatView{}
	for _, mf2 := range postList {
		pl = append(pl, mf2.ToView())
	}
